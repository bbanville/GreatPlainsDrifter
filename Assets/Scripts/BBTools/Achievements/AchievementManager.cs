...
namespace BrendonBanville.Tools
{
	...
	public static class AchievementManager
	{
		...
		private const string _saveFolderName = "Achievements/";
		...
		{
			DeterminePath ();
			SerializedAchievementManager serializedAchievementManager = (SerializedAchievementManager)SaveLoadManager.Load(_saveFileName+_saveFileExtension, _saveFolderName);
			ExtractSerializedAchievementManager(serializedAchievementManager);
		}
		...
		public static void ExtractSerializedAchievementManager(SerializedAchievementManager serializedAchievements)
		{
