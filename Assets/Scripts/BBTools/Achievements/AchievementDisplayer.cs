...
namespace BrendonBanville.Achievements
{
	...
	/// </summary>
	public class AchievementDisplayer : MonoBehaviour, NUEventListener<AchievementUnlockedEvent>
	{
		[Header("Achievements")]
		/// the prefab to use to display achievements
		public AchievementDisplayItem AchievementDisplayPrefab;
		...
		public virtual IEnumerator DisplayAchievement(Achievement achievement)
		{
			...
			AchievementDisplayItem achievementDisplay = instance.GetComponent<AchievementDisplayItem> ();
			...
			{
				NUSfxEvent.Trigger (achievement.UnlockedSound);
			}
			...
			if (achievementCanvasGroup != null)
			{
				...
				StartCoroutine(Fade.FadeCanvasGroup(achievementCanvasGroup, AchievementFadeDuration, 1));
				yield return _achievementFadeOutWFS;
				StartCoroutine(Fade.FadeCanvasGroup(achievementCanvasGroup, AchievementFadeDuration, 0));
			}
		}
		...
		public virtual void OnNUEvent(AchievementUnlockedEvent achievementUnlockedEvent)
		{
		...
		{
			this.NUEventStartListening<AchievementUnlockedEvent>();
		...
		{
			this.NUEventStopListening<AchievementUnlockedEvent>();
		}
	}
}