...
namespace BrendonBanville.Tools.Interactables
{
    ...
    {
        public static List<InteractionAreaBase> EnteredInteractions = new List<InteractionAreaBase>();
        public static InteractionAreaBase LastEnteredInteraction = null;
        ...
        public static InteractionAreaBase LockedInteraction = null;
