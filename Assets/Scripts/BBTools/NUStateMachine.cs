...
{
    public struct NUStateChangeEvent<T> where T : struct, IComparable, IConvertible, IFormattable
    {
        public GameObject Target;
        public NUStateMachine<T> TargetStateMachine;
        public T NewState;
        public T PreviousState;

        public NUStateChangeEvent(NUStateMachine<T> stateMachine)
        {
    ...
    /// </summary>
    public interface NUIStateMachine
    {
    ...
    /// </summary>
    public class NUStateMachine<T> : NUIStateMachine where T : struct, IComparable, IConvertible, IFormattable
    {
        ...
        public NUStateMachine(GameObject target, bool triggerEvents)
        {
            this.Target = target;
        ...
        public virtual void ChangeState(T newState)
        {
            ...
            if (TriggerEvents)
            {
                NUEventManager.TriggerEvent(new NUStateChangeEvent<T>(this));
            }
        }
