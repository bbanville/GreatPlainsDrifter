...
{
    [AddComponentMenu("BBTools/Camera Extensions/Camera Shaker")]
    public class CameraShaker : Singleton<CameraShaker>
    {
        ...
        void Update()
        {
            ...
            for (int i = 0; i < cameraShakeInstances.Count; i++)
            {
                ...
                {
                    posAddShake += VectorMethods.MultiplyVectors(c.UpdateShake(), c.PositionInfluence);
                    rotAddShake += VectorMethods.MultiplyVectors(c.UpdateShake(), c.RotationInfluence);
                }
            }
